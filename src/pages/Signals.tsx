...
import { Zap, TrendingUp, TrendingDown, Minus, RefreshCw, Download, Filter, Trash2, BarChart3, Target, Sparkles, Brain, Activity } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg p-8 border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-medium"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Sinais BUY</h3>
                  </div>
                  <p className="text-3xl font-bold text-green-700">{stats.buyCount}</p>
                  <p className="text-green-600 text-sm mt-1">Oportunidades de compra</p>
                </div>
